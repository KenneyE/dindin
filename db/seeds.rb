...
User.create!({email: "matthew.petrie@gmail.com", username: "eponymous", password: ENV['ADMIN_PASSWORD'], password_confirmation: ENV['ADMIN_PASSWORD']})

User.create!({email: "guest@test.com", username: "Guest",
          password: "password", password_confirmation: "password",
          saved_ingredient_ids: [5,7,12,45,62,27], favorite_recipe_ids: [1,2,3,4,5,6]})