...
(function() {
  ...
  $(function() {
    ...
    $('input#guest-login').click(function(e) {
      e.preventDefault();
    ...
    $('.menu-toggle').click(function(e) {
      ...
      e.preventDefault();
      return $('#site-wrapper').addClass('show-nav');
    });
  ...
  Backbone.CompositeView = Backbone.View.extend({
    addSubview: function(selector, subview) {
      var $selectorEl, selectorSubviews;
      selectorSubviews = this.subviews()[selector] || (this.subviews()[selector] = []);
      selectorSubviews.push(subview);
      $selectorEl = this.$(selector);
      return $selectorEl.append(subview.$el);
    },
    remove: function() {
      Backbone.View.prototype.remove.call(this);
      return _(this.subviews()).each(function(selectorSubviews, selector) {
        return _(selectorSubviews).each(function(subview) {
          return subview.remove();
        });
      });
    },
    removeSubview: function(selector, subview) {
      var selectorSubviews, subviewIndex;
      selectorSubviews = this.subviews()[selector] || (this.subviews()[selector] = []);
...
(function() { this.JST || (this.JST = {}); this.JST["ingredients/_new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="modal fade" id="new-ingredient-modal" tabindex="-1" role="dialog" aria-labelledby="AddIngredientModal" aria-hidden="true" aria-describedby="add new ingredient box">\n  <div class="modal-dialog modal-sm">\n    <div class="modal-content recipe">\n      <div class="modal-header">\n        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\n        <h4 class="modal-title">New Ingredient</h4>\n      </div>\n      <form id="new-ingredient-form">\n        <label for="ingredient-name">Name:</label>\n        <input type="text" name="ingredient[name]" id="ingredient-name" value="',  text ,'" class="form-control"><br>\n        <label for="ingredient-category">Category:</label>\n        <select class="form-control" name="ingredient[category]">\n          <option class="btn-danger" value="Protein">Protein</option>\n          <option class="btn-success" value="Vegetables">Vegetables</option>\n          <option class="btn-primary" value="Fruit">Fruit</option>\n          <option class="btn-warning" value="Grains & Legumes">Grains & Legumes</option>\n          <option class="btn-info" value="Dairy">Dairy</option>\n          <option class="btn-other" value="Other">Other</option>\n        </select>\n      <div class="modal-footer">\n          <input type="submit" value="Create Ingredient" class="btn btn-primary pull-right">\n        </form>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["ingredients/_selector"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label for="ingredient-search">Choose Ingredients:</label>\n<div class="input-group">\n  <input type="text" id="ingredient-search" placeholder="search for an ingredient by typing its name here" class="form-control">\n  <span class="input-group-btn">\n    <button class="btn btn-primary">add new ingredient</button>\n  </span>\n</div>\n</div>\n<ul class=\'ingredient-list ing-sort well\'>\n</ul>\n\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["ingredients/_tile"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="ingredient-tile ',  tileColor ,'">\n  <h3 class="ingredient-tile-name">',  ingredient.escape('name') ,'</h3>\n  <p class="ingredient-tile-category small">',  ingredient.escape('category') ,'</p>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["ingredients/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2 class="text-center">Ingredients</h2>\n<hr>\n<div class="ingredient-selector-box"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/_matches"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="recipe-list sortable"></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/_tile"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="recipe-tile">\n  <div class="recipe-tile-inner">\n  <div class="front">\n    ');  if(recipe.escape('large_image_url')){ ; __p.push('\n      <img src="',  recipe.escape('large_image_url') ,'" />\n    ');  }else{ ; __p.push('\n      <img src="',  recipe.escape('small_image_url') ,'" />\n    ');  } ; __p.push('\n    <div class="caption_title">\n      <h5>',  recipe.escape('title') ,'</h5>\n    </div>\n  </div>\n  <div class="front back">\n    ');  if(matchedIngredients.length > 0){ ; __p.push('\n    <h5>Ingredients You Have:</h5>\n    <ul>\n      ');  _(matchedIngredients).each(function(ingredient){ ; __p.push('\n          <li>',  ingredient ,',</li>\n      ');  }) ; __p.push('\n    </ul>\n    ');  } ; __p.push('\n    <h5>Ingredients You Need:</h5>\n    <ul>\n      ');  _(otherIngredients).each(function(ingredient){ ; __p.push('\n        <li>',  ingredient ,'</li>\n      ');  }) ; __p.push('\n    </ul>\n  </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Edit Recipe</h1>\n<hr>\n<form id="new-recipe-form">\n  <label for="recipe-title">Title</label>\n  <input type="text" name="recipe[title]" id="recipe-title"\n    value="',  recipe.escape('title') ,'" class="form-control"><br>\n  <span class="btn btn-success btn-file">\n    Upload an Image<input type="file" multiple id="recipe-image" name="recipe[image]" class="form-control">\n  </span><br>\n  <label for="recipe-description">Short Description</label>\n  <textarea name="recipe[short_description]"\n    id="recipe-description" class="form-control"\n    rows="4">',  recipe.escape('short_description') ,'</textarea><br>\n  <div class="ingredient-selector-box"></div>\n  <br><label for="recipe-body">Instructions:</label>\n  <textarea name="recipe[body]"\n    id="recipe-description" class="form-control"\n    rows="8">',  recipe.escape('body') ,'</textarea><br>\n    <input type="submit" value="Edit Recipe" class="btn btn-lg btn-primary pull-right">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2 class="text-center">Your Favorite Recipes</h2>\n<hr>\n<ul class="recipe-list favorite-recipes"></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>New Recipe</h1>\n<hr>\n<form id="new-recipe-form">\n  <label for="recipe-title">Title</label>\n  <input type="text" name="recipe[title]" id="recipe-title"\n    placeholder="What do you call your recipe?" class="form-control"><br>\n  <span class="btn btn-success btn-file">\n    Upload an Image<input type="file" multiple id="recipe-image" name="recipe[image]" class="form-control">\n  </span><br>\n  <label for="recipe-description">Short Description</label>\n  <textarea name="recipe[short_description]"\n    id="recipe-description" class="form-control"\n    rows="4"\n    placeholder="What makes this recipe so great?"></textarea><br>\n  <div class="ingredient-selector-box"></div>\n  <br><label for="recipe-body">Instructions:</label>\n  <textarea name="recipe[body]"\n    id="recipe-description" class="form-control"\n    rows="8"\n    placeholder="How do you make it? You can use markdown to style your instructions here."></textarea><br>\n    <input type="submit" value="Create Recipe" class="btn btn-lg btn-primary pull-right">\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <div class="col-md-12">\n    <h2>Search for Recipes</h2>\n    <hr>\n  </div>\n</div>\n<div class="row">\n  <div class="col-md-6 pull-left">\n    <label>Selected Ingredients:</label>\n    <ul class="selected-ingredients ing-sort well">\n    </ul>\n  </div>\n  <div class="col-md-6 pull-right">\n    <ul class="ingredient-selector-box sortable"></ul>\n  </div>\n  <div class="col-md-6 pull-left">\n    <hr>\n    <h4>Matching Recipes:</h4>\n    <div id="loading"></div>\n    <div class="recipe-matches"></div>\n  </div>\n\n</div>\n<div class="row">\n  <div class="col-md-12">\n    <hr>\n    <p class=\'text-center small\'>Recipe search powered by <a href=\'http://www.yummly.com/recipes\'><img alt=\'Yummly\' src=\'http://static.yummly.com/api-logo.png\'/></a></p>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["recipes/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">\n  <div class="text-center col-xs-8 col-md-offset-2">\n    <h2>',  recipe.escape('title') ,'</h2>\n    <h6>Recipe From: <a href="',  recipe.escape('source_site_url') ,'">',  recipe.escape('source_display_name') ,'</a></h6>\n    ');  if(recipe.escape('total_time')) { ; __p.push('\n      <p>Total Prep Time: ',  recipe.escape('total_time') ,'</p>\n    ');  } ; __p.push('\n  </div>\n  <div class="col-xs-2"><span data-container="div.col-xs-2" data-toggle="popover" data-placement="right" data-trigger="hover"data-content="Click to ',  addOrRemove ,' favorites."class="favorite-button ',  favorited ,' glyphicon glyphicon-heart"></span></div>\n  <div class="col-xs-12">\n      <hr>\n  </div>\n</div>\n<div class="row">\n  <div class="col-md-4">\n    <h3>Ingredients:</h3>\n    ');  if(ingredientMatches.length > 0){ ; __p.push('\n    <h5>You have:</h5>\n    <ul>\n      ');  _(ingredientMatches).each(function(ingredient) { ; __p.push('\n        <li>',  ingredient ,'</li>\n      ');  }) ; __p.push('\n    </ul>\n    ');  } ; __p.push('\n    <h5>You need:</h5>\n      <ul>\n        ');  _(otherIngredients).each(function(ingredient) { ; __p.push('\n          <li>',  ingredient ,'</li>\n        ');  }) ; __p.push('\n    </ul>\n  </div>\n  <div class="col-md-8">\n     <img src="',  recipe.escape('large_image_url') ,'" class="img img-responsive img-rounded recipe-image center-block">\n  <hr>\n  <h4 class="text-center">Read full instructions on <a href="',  recipe.escape('source_recipe_url') ,'" target="_blank">',  recipe.escape('source_display_name') ,'.</a></h4>\n  </div>\n</div>\n<div class="row">\n  <div class="col-md-12 credit">\n    <hr>\n    <p class="text-center small">',  recipe.get('credit') ,'</p>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/fridge"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h4>',  user.escape('username') ,'\'s ingredients:</h4>\n<p class="small">Drag and drop to add. Double click to remove.<br>\nYou can press \'esc\' to close the fridge.</p>\n<ul class="sortable well ing-sort" id="fridge-ingredients">\n  ');  if(user.escape('username') === 'Guest'){ ; __p.push('\n    <li class="text-center"><h4>You need to be logged in to store ingredients. <a href="/users/sign_up/">Click here</a> to sign up.</h4></li>\n  ');  } ; __p.push('\n</ul>\n');}return __p.join('');};
}).call(this);
(function() {
  Dindin.Models.Ingredient = Backbone.Model.extend({
...
(function() {
  Dindin.Models.Recipe = Backbone.Model.extend({
    initialize: function() {
      return this.matchedIngredients = this.ingredientMatches();
    },
    urlRoot: '/api/recipes',
    ingredientMatches: function() {
      var matches, that;
      matches = [];
      that = this;
      Dindin.currentUser.ingredients().each(function(userIngredient) {
        ...
        _(that.get('ingredients')).each(function(ingredient) {
    ...
    numberOfMatches: function() {
      return this.matchedIngredients.length;
    },
    otherIngredients: function() {
      return _(this.get('ingredients')).filter((function(_this) {
        return function(ingredient) {
          return _this.ingredientMatches().indexOf(ingredient) === -1;
        };
      })(this));
    }
  });
...
(function() {
  Dindin.Models.User = Backbone.Model.extend({
    ...
    favoriteRecipes: function() {
      this._favoriteRecipes = this._favoriteRecipes || new Dindin.Collections.UserFavoriteRecipes([], {
        user: this
      });
      return this._favoriteRecipes;
    },
    ingredients: function() {
      this._ingredients = this._ingredients || new Dindin.Collections.UserIngredients([], {
        user: this
      });
    ...
    parse: function(resp) {
      if (resp.saved_ingredients) {
        this.ingredients().set(resp.saved_ingredients, {
          parse: true
        });
        delete resp.saved_ingredients;
      }
      if (resp.favorite_recipes) {
        this.favoriteRecipes().set(resp.favorite_recipes, {
          parse: true
        });
...
(function() {
  Dindin.Collections.Ingredients = Backbone.Collection.extend({
    byCategory: function(category) {
      var filtered;
      filtered = this.filter(function(ingredient) {
    ...
    getOrFetchById: function(id) {
      ...
      if (model) {
        ...
        model = new Dindin.Models.Recipe({
          id: id
        });
        model.fetch({
          success: function() {
            return recipes.add(model);
          }
        });
      }
      return model;
    ...
    search: function(letters) {
      ...
      return _(this.filter(function(ingredient) {
        return pattern.test(ingredient.get('name'));
      }));
    },
    url: 'api/ingredients'
  });
...
(function() {
  Dindin.Views.IngredientSelector = Backbone.CompositeView.extend({
    ...
    removeSubviewByDataId: function(id, selector) {
      var idIndex, selectedSubview;
      selectedSubview = _.find(this.subviews()[selector], function(subview) {
        return subview.attributes()['data-id'] === id;
      });
      this.removeSubview(selector, selectedSubview);
      idIndex = this.selectedIds.indexOf(id);
      return this.selectedIds.splice(idIndex, 1);
    },
    render: function() {
      var renderedContent;
      renderedContent = this.template({
    ...
    selectIngredient: function(event) {
      ...
      return $('.selected-ingredients').trigger("ingredientSelected", {
        ids: this.selectedIds
      });
    },
    setSortable: function() {
      return this.$el.find('.ing-sort').sortable({
        axis: 'x,y',
    ...
    toggleNewPrompt: function() {
      var content;
      if (this.subviews()['.ingredient-list'].length === 0) {
        content = $('#ingredient-search').val();
        return $('.ingredient-list').append("<h5 class='no-drag'>No matched ingredients. Click 'add new ingredient' to add a new one.</h5>");
      }
    },
    toggleSelected: function(el) {
      var id, selectedSubview, subviewIndex;
      id = el.data('id');
      if (!el.data('selected')) {
        el.data('selected', true);
        selectedSubview = _.find(this.subviews()['.ingredient-list'], function(subview) {
          return subview.attributes()['data-id'] === id;
        });
        ...
        return this.removeSubviewByDataId(id, '.selected-ingredients');
      }
    },
    unSelectIngredient: function(event) {
      ...
      return this.toggleSelected(content);
    }
  });
...
(function() {
  Dindin.Views.RecipeMatches = Backbone.CompositeView.extend({
    initialize: function() {
      ...
      return this.collection.each(this.addRecipe.bind(this));
    },
    ...
    removeRecipes: function() {
      return this.removeSubviews('.recipe-list');
    },
    toggleEmptyPrompt: function() {
      var $matches;
      $matches = this.$el.find('.recipe-list');
      if ($matches.children().length === 0) {
        $matches.append("<h4 class='text-center placeholder'>No recipes currently found. Try adding or removing ingredients from the selector to discover new recipes.</h4>");
      } else {
    ...
    addRecipe: function(event) {
      ...
      recipe.save({}, {
        success: function() {
          ...
          Backbone.history.navigate('/recipes/' + recipe.id, {
            trigger: true
          });
        }
      });
...
(function() {
  Dindin.Views.RecipeShow = Backbone.View.extend({
    initialize: function() {
      ...
      return this.listenTo(Dindin.currentUser, 'sync', this.render);
    },
    ...
    render: function() {
      var addOrRemove, favorited, renderedContent;
      if (Dindin.currentUser.favoriteRecipes().findWhere({
        id: this.model.id
      })) {
        favorited = "favorited";
    ...
    toggleFavorite: function() {
      var id, recipeIds, recipes;
      id = this.model.id;
      recipes = Dindin.currentUser.favoriteRecipes();
      if (recipes.findWhere({
        id: this.model.id
      })) {
      ...
      recipeIds = recipes.map(function(recipe) {
        return recipe.get('id');
      });
      if (recipeIds.length === 0) {
        recipeIds = ['empty'];
      }
      return Dindin.currentUser.save({
        user: {
          'favorite_recipe_ids': recipeIds
        }
      }, {
        patch: true
      });
...
(function() {
  Dindin.Views.RecipeTile = Backbone.View.extend({
    ...
    goToShowPage: function(event) {
      ...
      that = this;
      if (this.model.id) {
        return Backbone.history.navigate('/recipes/' + this.model.id, {
          trigger: true
        });
      } else {
        this.model.save({}, {
          success: (function(_this) {
            return function() {
              _this.model.fetch({
                success: function() {
                  Backbone.history.navigate('/recipes/' + _this.model.id, {
                    trigger: true
                  });
                }
              });
...
(function() {
  Dindin.Views.RecipesSearch = Backbone.CompositeView.extend({
    initialize: function() {
      ...
      return this.addSubview('.ingredient-selector-box', this.ingredientSelector);
    },
    addSearchSpinner: function() {
      var spinnerOpts;
      spinnerOpts = {
        lines: 13,
        length: 20,
    ...
    handleSelect: function(event, data) {
      return this.searchByIds(data.ids);
    },
    ...
    setSortable: function() {
      return this.$el.find('.ing-sort').sortable({
        ...
        receive: (function(_this) {
          return function(event, ui) {
            var ingredientIds;
            ingredientIds = $('.selected-ingredients').sortable('toArray', {
              attribute: 'data-id'
            });
            ingredientIds = _(ingredientIds).filter(function(id) {
              return id !== "";
            });
            if (ui.sender.attr('id') !== 'fridge-ingredients') {
              _this.ingredientSelector.toggleSelected(ui.item);
            }
            return _this.searchByIds(ingredientIds);
          };
        })(this),
        update: (function(_this) {
          return function(event, ui) {
            return _this.togglePlaceholder();
          };
        })(this)
      });
    },
    searchByIds: function(ids) {
      var $recipes, formData;
      ...
      if (ids.length > 0) {
        ...
        return this.collection.fetch({
          ...
          success: (function(_this) {
            return function() {
              return _this.removeSearchSpinner();
            };
          })(this)
        });
      }
    ...
    togglePlaceholder: function() {
      ...
      if ($ingredientSelector.children().length === 0) {
        return $ingredientSelector.append('<h3 class="text-center placeholder no-drag">Drag and drop ingredient tiles here to search for recipes.</h3>');
      } else {
        return $ingredientSelector.find('.placeholder').remove();
      }
    }
  });
...
(function() {
  Dindin.Views.UserFridge = Backbone.CompositeView.extend({
    ...
    addIngredient: function(ingredient) {
      ...
      return this.addSubview('#fridge-ingredients', ingredientTileView);
    },
    events: {
    ...
    removeIngredientByClick: function(event) {
      var $tile, id;
      $tile = $(event.currentTarget);
      id = $tile.data('id');
      $tile.fadeOut(200, (function(_this) {
        return function() {
          return _this.removeIngredient(id);
        };
      })(this));
    },
    removeIngredient: function(id) {
      var ingredient, ingredientIds;
      ...
      ingredientIds = this.model.ingredients().map(function(ingredient) {
      ...
      return this.model.save({
        user: {
          'saved_ingredient_ids': ingredientIds
        }
      }, {
        patch: true
      });
    ...
    removeSubviewByDataId: function(id, selector) {
      ...
      return this.removeSubview(selector, selectedSubview);
    },
    render: function() {
      var renderedContent;
      if (!this.model.escape('username')) {
        this.model.set({
          username: 'Guest'
        });
      }
      ...
      return this.$el.find('.ing-sort').sortable({
        ...
        receive: (function(_this) {
          return function(event, ui) {
            var id;
            id = ui.item.data('id');
            return _this.updateSavedIngredients(id);
          };
        })(this),
        remove: (function(_this) {
          return function(event, ui) {
            var id;
            id = ui.item.data('id');
            if (ui.item.parent().hasClass('ingredient-list')) {
              _this.removeIngredient(id);
            }
            if (ui.item.parent().hasClass('selected-ingredients')) {
              return ui.item.data('selected', true);
            }
          };
        })(this)
      });
    ...
    updateSavedIngredients: function(id) {
      var ingredientIds, newIngredient;
      newIngredient = new Dindin.Models.Ingredient({
        id: id
      });
      newIngredient.fetch();
...
(function() {
  ...
  searchTour.addStep('intro', {
    text: 'Congratulations, your Shepherd tour is working',
    attachTo: 'body',
    buttons: [
      {
        text: 'Next',
